...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			double timeStartBasic = System.nanoTime();
			Document a = new BasicDocument(test);
			a.getFleschScore();			
			double timeStopBasic = System.nanoTime();
			double timerBasic = timeStopBasic - timeStartBasic;
			
			
			double timeStartEfficient = System.nanoTime();
			Document b = new EfficientDocument(test);
			b.getFleschScore();
			double timeStopEfficient = System.nanoTime();
			double timerEfficient = timeStopEfficient - timeStartEfficient;
			
			System.out.println(numToCheck + "\t" + (int)timerBasic + "\t" + (int)timerEfficient );
		}

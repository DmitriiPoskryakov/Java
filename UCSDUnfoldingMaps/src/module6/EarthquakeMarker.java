...
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker>
{
	...
	public int compareTo(EarthquakeMarker marker){
		int a = 0;
		if ((float)getProperty("magnitude") > (float)marker.getProperty("magnitude")) a = - 1;
		if ((float)getProperty("magnitude") < (float)marker.getProperty("magnitude")) a = 1;
		if ((float)getProperty("magnitude") == (float)marker.getProperty("magnitude")) a = 0;
		return a; //(getProperty("magnitude")).compareTo(marker.getProperty("magnitude"));
	}
